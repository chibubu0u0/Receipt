...
async function downloadPng() {
  ...
  try {
    ...
    const node = els.captureArea || document.querySelector(".receipt-wrap") || els.receipt;
    ...
    els.savePanelText.textContent = "白底收據 PNG 已產生。請長按圖片，選擇「儲存到照片」或「加入照片」。";
