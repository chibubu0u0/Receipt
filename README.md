...
- 方形版面改成更精簡的 1:1 poster layout
- 不再把過多長內容塞進正方形
- 方形卡片固定在 1:1 畫布內，不會往下撐開
- 保留歌曲、標語、靈魂摘要、情緒濃度、色彩、情緒輪廓、具現化摘要、結帳摘要
- 外層輸出背景維持透明
...
這版修正上一版「整張圖片下載後變黑」的問題：

- 匯出節點改成 `.receipt-wrap`，避免抓到外層黑色預覽區
- 匯出時外層仍移除黑底與陰影
- 但收據紙本身會保留紙色，不會被設成透明
- 熱感應紙 / 極簡收藏卡 / 深夜黑票都保留各自的紙面背景
- 下載時仍移除黑色陰影與外框
...
- 中文主要文字顏色從接近黑色改成較柔和的深灰棕
- 章節標題、表格標題、輔助文字改成更淡的灰棕色
- 保留英文歌名與數字的可讀性
- 深夜黑票模式不強制套用這組顏色，避免夜間主題可讀性下降
